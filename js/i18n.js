    ...
    'pt-BR': {
      ui: {
        ...
        file: {
          ...
          importedUrl: 'Importado {name} da web (somente leitura - use Exportar para salvar)',
          importError: 'Não foi possível importar: {message}',
          importUrlTitle: 'Importar HTML de uma URL',
          importUrlMsg: 'Cole o endereço de uma página web que permita leitura pelo navegador (CORS). A página será copiada para o editor; use Exportar para salvar.',
    ...
    en: {
      ui: {
        ...
        file: {
          ...
          importedUrl: 'Imported {name} from the web (read-only - use Export to save)',
          importUrlTitle: 'Import HTML from URL',
          importUrlMsg: 'Paste a web page address that allows browser reads (CORS). The page will be copied into the editor; use Export to save it.',
